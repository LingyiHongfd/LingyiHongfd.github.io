...
- ``AAAI 2026`` [Seeing is Believing: Rich-Context Hallucination Detection for MLLMs via Backward Visual Grounding](https://ojs.aaai.org/index.php/AAAI/article/view/40345), 
...
- ``ICCV 2025 Workshop`` [LSVOS 2025 Challenge Report: Recent Advances in Complex Video Object Segmentation](https://arxiv.org/abs/2510.11063), 
Chang Liu, Henghui Ding, Kaining Ying, **Lingyi Hong**, Ning Xu, Linjie Yang, Yuchen Fan, et al.

- ``TCSVT 2025`` [ClickVOS: click video object segmentation](https://ieeexplore.ieee.org/abstract/document/11124887), 
Pinxue Guo, **Lingyi Hong**, Xinyu Zhou, Shuyong Gao, Wanyun Li, Jinglun Li, Zhaoyu Chen, Xiaoqiang Li, Wei Zhang, Wenqiang Zhang

- ``NeurIPS 2025`` [Dynamic Semantic-Aware Correlation Modeling for UAV Tracking](https://arxiv.org/abs/2510.21351), 
Xinyu Zhou, Tongxin Pan, **Lingyi Hong**, Pinxue Guo, Haijing Guo, Zhaoyu Chen, Kaixun Jiang, Wenqiang Zhang

- ``Arxiv 2025`` [Progressive scaling visual object tracking](https://arxiv.org/abs/2505.19990), 
**Jack Hong**, Shilin Yan, Zehao Xiao, Jiayin Cai, Xiaolong Jiang, Yao Hu, Henghui Ding

- ``ECCV 2024 Workshop`` [LSVOS Challenge Report: Large-Scale Complex and Long Video Object Segmentation](https://link.springer.com/chapter/10.1007/978-3-031-91856-8_22), 
Henghui Ding, **Lingyi Hong**, Chang Liu, Ning Xu, Linjie Yang, Yuchen Fan, et al.
...
- ``ICLR 2026`` [Lingoloop attack: Trapping mllms via linguistic context and state entrapment into endless loops](https://arxiv.org/abs/2506.14493), 
Jiyuan Fu, Kaixun Jiang, **Lingyi Hong**, Jinglun Li, Haijing Guo, Dingkang Yang, Zhaoyu Chen, Wenqiang Zhang

- ``CVPR 2025 Workshop`` [NTIRE 2025 challenge on cross-domain few-shot object detection: Methods and results](https://ieeexplore.ieee.org/abstract/document/11031449), 

- ``Arxiv 2025`` [P3S-Diffusion: A selective subject-driven generation framework via point supervision](https://arxiv.org/abs/2412.19533), 
Junjie Hu, Shuyong Gao, **Lingyi Hong**, Qishan Wang, Yuzhou Zhao, Yan Wang, Wenqiang Zhang

- ``TCSVT 2025`` [Videopure: Diffusion-based adversarial purification for video recognition](https://ieeexplore.ieee.org/abstract/document/11031449), 
...
- ``ICCV 2025`` [MSVCOD:A Large-Scale Multi-Scene Dataset for Video Camouflage Object Detection](https://openaccess.thecvf.com/content/ICCV2025/html/Feng_Scoring_Remember_and_Reference_Catching_Camouflaged_Objects_in_Videos_ICCV_2025_paper.html), 
Yu'ang Feng, Shuyong Gao, Fuzhen Yan, Yicheng Song, **Lingyi Hong**, Junjie Hu, Wenqiang Zhang

- ``Arxiv 2025`` [MSVCOD:A Large-Scale Multi-Scene Dataset for Video Camouflage Object Detection](https://arxiv.org/abs/2506.14493), 
